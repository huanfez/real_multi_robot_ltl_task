...
taskplan_status_1.step = 0
taskplan_status_1.group = 1

taskplan_status_2 = PlanindexGoal()
taskplan_status_2.step = 1
taskplan_status_2.group = 0

taskplan_status_3 = PlanindexGoal()
taskplan_status_3.step = 1
taskplan_status_3.group = 1

taskplan_status_mat = [[taskplan_status_0, taskplan_status_1],\
   [taskplan_status_2, taskplan_status_3]]
