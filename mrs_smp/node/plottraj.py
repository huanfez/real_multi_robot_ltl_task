...
#  traj1_a_x, traj1_a_y = np.loadtxt(currentDir + 'traj1_a.txt' , delimiter = ' ', unpack = True)
#  traj1_d_x, traj1_d_y = np.loadtxt(currentDir + 'traj1_d.txt' , delimiter = ' ', unpack = True)
...
#traj2_a_x, traj2_a_y = np.loadtxt(currentDir + 'trajtba.txt' , delimiter = ' ', unpack = True)
traj2_d_x, traj2_d_y = np.loadtxt(currentDir + 'traj34d.txt' , delimiter = ' ', unpack = True)
#plt.plot(traj2_a_x, traj2_a_y, 'r:', label = 'actual')
plt.plot(traj2_d_x, traj2_d_y, 'b:', label = 'desired')
